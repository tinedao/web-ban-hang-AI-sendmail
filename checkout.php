...
<div class="container py-5 fade-in-page">
    <div class="text-center mb-5">
        <h1 class="font-heading display-5">Checkout</h1>
            ...
            <form id="checkoutForm" method="POST" action="">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white p-4 border-bottom-0">
                        <h5 class="font-heading mb-0">1. Payment Method</h5>
                    </div>
                    <div class="card-body p-4 pt-0">
                        <div class="btn-group w-100" role="group">
                            ...
                            <label class="btn btn-outline-dark py-3" for="pm_cod">
                                <i class="fa-solid fa-truck me-2"></i> Cash on Delivery
                            </label>
                            ...
                            <label class="btn btn-outline-dark py-3" for="pm_online">
                                <i class="fa-regular fa-credit-card me-2"></i> Online Payment
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div id="section-shipping" class="card border-0 shadow-sm mb-4 transition-section">
                    <div class="card-header bg-white p-4 border-bottom-0">
                        <h5 class="font-heading mb-0">2. Shipping Details</h5>
                    </div>
                    <div class="card-body p-4 pt-0">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <label class="form-label-luxury">Invoice Email (Optional)</label>
                                ...
                                <div class="form-text">We will send the invoice to this email. Clear it if you don't want to receive one.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="section-online" class="card border-0 shadow-sm mb-4 transition-section d-none">
                    <div class="card-header bg-white p-4 border-bottom-0">
                        <h5 class="font-heading mb-0">2. Scan to Pay</h5>
                    </div>
                    <div class="card-body p-4 pt-0 text-center">
                        <div class="alert alert-info border-0 bg-info-subtle text-info-emphasis mb-3">
                            <small><i class="fa-solid fa-circle-info me-2"></i>Please scan the QR code below using your banking app.</small>
                        </div>
                        ...
                        <p class="text-muted small mb-0">Transaction ID: <strong><?= $randomTransId ?></strong> | Amount: <strong class="text-dark"><?= formatVND($totalPrice) ?></strong></p>
                        <div id="payment-timer" class="mt-3 text-accent d-none">
                            <i class="fa-solid fa-spinner fa-spin me-2"></i> Verifying payment...
                        </div>
                    </div>
                </div>

                <button type="submit" id="btn-submit" class="btn btn-luxury w-100 py-3 mt-2">Place Order</button>
            </form>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const togglePayment = () => {
        ...
        if (method === 'cod') {
            ...
            btnSubmit.textContent = 'Proceed to Payment';
        }
    };
        ...
        if (method === 'online') {
            ...
            if (!isQrShown) {
                ...
                if (form.checkValidity()) {
                    ...
                    isQrShown = true;
                    btnSubmit.textContent = 'Confirm Payment & Order';
