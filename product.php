...
<div class="container py-5 fade-in-page">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb breadcrumb-luxury">
            ...
            <li class="breadcrumb-item"><a href="category.php">Danh mục sản phẩm</a></li>
        ...
        <div class="col-lg-6">
            <div class="ps-lg-4">
                ...
                <div class="d-grid gap-3 d-md-flex">
                    <?php if (isLogin()): ?>
                        <button class="btn btn-luxury flex-grow-1 py-3" onclick="addToCart(<?= $product['id'] ?>)">
                            <i class="fa-solid fa-bag-shopping me-2"></i> Thêm vào giỏ hàng
                        </button>
                    ...
                    <?php else: ?>
                        <a href="login.php?msg=cart" class="btn btn-luxury flex-grow-1 py-3">
                            <i class="fa-solid fa-lock me-2"></i> Đăng nhập để mua hàng
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <div class="mt-4 pt-2 d-flex gap-4 text-muted small">
                    <span><i class="fa-solid fa-check me-2"></i>Đảm bảo hàng chính hãng</span>
                    <span><i class="fa-solid fa-truck-fast me-2"></i>Miễn phí ship</span>
                </div>
            </div>
        </div>
    </div>
