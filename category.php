...
<div class="container py-5">
    ...
    <div class="text-center mb-5">
        <h1 class="display-5">Sản phẩm sự kiện trong năm</h1>
        ...
        <div class="col-lg-3 mb-5">
            <div class="sidebar-wrapper sticky-top" style="top: 100px; z-index: 1;">
                <form id="filterForm">
                    ...
                    <!-- Reset Button -->
                    <div class="mt-4">
                        <button type="button" class="btn btn-outline-dark btn-sm w-100 rounded-0 text-uppercase" onclick="resetFilters()" style="letter-spacing: 1px; font-size: 0.75rem;">Bỏ bộ lọc</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="row g-4" id="product-grid">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="card product-card h-100">
                                ...
                                <div class="card-body product-info">
                                    <span class="product-specs">Đồ sự kiện</span>
                                    <h5 class="product-title"><?= htmlspecialchars($product['name']) ?></h5>
                                    <p class="product-price"><?= formatVND($product['price']) ?></p>
                                    
                                    <div class="product-actions">
                                        <a href="product.php?id=<?= $product['id'] ?>" class="btn-view-details">Xem chi tiết</a>
                                        <?php if (isLogin()): ?>
                                            <a href="#" class="btn-view-more btn-add-cart" data-id="<?= $product['id'] ?>">Thêm vào giỏ hàng</a>
                                        <?php else: ?>
                                            <a href="login.php?msg=cart" class="btn-view-more">Đăng nhập để mua hàng</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <?php else: ?>
                    <div class="col-12 text-center py-5">
                        ...
                        <button type="button" class="btn btn-luxury mt-3" onclick="resetFilters()">Xem tất cả sản phẩm</button>
                    </div>
                <?php endif; ?>
            </div>
